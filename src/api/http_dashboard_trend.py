...
from src.api.analytics.trend import build_trend_response
...
def parse_trend_filters(path: str) -> AnalyticsFilters:
...
def handle_trend(path: str) -> dict:
    filters = parse_trend_filters(path)
    return build_trend_response(filters)
