...
from src.api.analytics.disease_insights import build_disease_insights_response
...
def parse_disease_insights_filters(path: str) -> AnalyticsFilters:
...
def handle_disease_insights(path: str) -> dict:
    return build_disease_insights_response(parse_disease_insights_filters(path))
